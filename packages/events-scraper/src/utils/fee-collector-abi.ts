...
const ABI_FEE_COLLECTOR_V1 = [
  ...
  { inputs: [], name: 'NativeValueWithERC', type: 'error' },
  ...
  { inputs: [], name: 'TransferFailure', type: 'error' },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'lifiFee', type: 'uint256' },
      { internalType: 'address', name: 'integratorAddress', type: 'address' },
    ],
